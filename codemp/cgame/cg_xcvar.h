...
// Strafe helper / speedometer / racing HUD
...
XCVAR_DEF( cg_speedometerSpeedAlign,		"0.0",		NULL,	CVAR_ARCHIVE )
...
XCVAR_DEF( cg_lagometerX,					"10",		NULL,	CVAR_ARCHIVE )
XCVAR_DEF( cg_lagometerY,					"10",		NULL,	CVAR_ARCHIVE )
XCVAR_DEF( cg_snapHud,						"0",		NULL,	CVAR_ARCHIVE )
XCVAR_DEF( cg_snapHudRgba1,				"127 179 230 179",	NULL,	CVAR_ARCHIVE )
XCVAR_DEF( cg_snapHudRgba2,				"127 127 127 38",	NULL,	CVAR_ARCHIVE )
...
XCVAR_DEF( cg_pitchHudRgba,				"204 204 204 204",	NULL,	CVAR_ARCHIVE )
